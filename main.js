...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_wp66kkt','template_g9x1e4j','#contact-form','t1zSNuFp-JyQGM_fm')
    .then(()=>{
...
themeButton.addEventListener('click', () =>{
    ...
    // We save the theme and the current icon that the user choses
...
sr.reveal('.home__perfil, .about__image,.contact__container', {origin:'right'})
